    ...
    <div className="w-9/12 mx-auto pt-16 md:pt-48 mb-20 md:mb-32">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 pt-10">
        <div className="relative min-h-[20rem]">
          ...
          />
          <div
            className="opacity-[0] absolute flex  bg-black/70 hover:opacity-100 top-0 left-0 w-full h-full justify-start"
            style={{ transition: "opacity 300ms ease-in-out" }}
          >
            <h3 className="p-3 text-[1rem] text-white">The best day.</h3>
          </div>
        </div>
